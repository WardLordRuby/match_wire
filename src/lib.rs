...
// 2. grab tracing and set up tracing as well as our map save to file
// 3. create map of host-name -> (ip:port, region)
...
pub fn check_app_dir_exists(local: &mut std::path::PathBuf) -> std::io::Result<()> {
